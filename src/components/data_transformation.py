...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            categorical_cols = []
            numerical_cols = ['X1', 'X2', 'X3', 'X4', 'X5', 'X6', 'X7', 'X8', 'X9', 'X10', 'X11', 'X12', 'X13', 'X14', 
                              'X15', 'X16', 'X17', 'X18', 'X19', 'X20', 'X21','X22','X23']
            # There is no categorical columns, hence no need of custom ranking

            #Initiating the pipeine
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            #converting data into array to load array quickly
            # numpy array is superfast for ML
            train_arr=np.c_[input_feature_train_arr,np.array(target_feature_train_df)]
            test_arr=np.c_[input_feature_test_arr,np.array(target_feature_test_df)]

            #saving pickle file from preprocessing object
            save_object(
